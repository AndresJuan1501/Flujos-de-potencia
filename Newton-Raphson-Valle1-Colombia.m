...
while ~Validacion
    ...
    escenario = input('Ingrese el escenario que desea simular, en su tap "nominal"(1), "máximo"(2) o "mínimo"(3): ', 's');  % Pedir la entrada como texto ('s') adicionalmente
    ...
    if iter > 2
        for k = idx_PV_orig
            ...
            if tipo_actual(k) == 3 % Si es PV, verificamos si viola
                ...
                % Esta lógica es opcional, por ahora dejemos que se quede limitada
